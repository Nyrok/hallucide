...
class ClaudeModelProvider:
    ...
    def generate(
        ...
        if tool_choice == "required" and not self.supports_forced_tool_calling:
            raise SentinelGuardError("Claude provider does not support forced tool calling.")
        ...
        try:
            ...
            raise SentinelGuardError(f"Claude API connection error: {exc.reason}") from exc
    ...
    def _send_request(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            raise SentinelGuardError("Claude API returned malformed JSON.") from exc
    ...
    def _extract_text(self, data: dict[str, Any]) -> str:
        ...
        raise SentinelGuardError("Unable to extract text output from Claude API response.")
